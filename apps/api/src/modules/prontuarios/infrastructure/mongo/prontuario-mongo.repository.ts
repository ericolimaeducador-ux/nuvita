...
export class ProntuarioMongoRepository implements ProntuarioRepository {
  ...
  private toProntuario(document: ProntuarioDocument): Prontuario {
    ...
    return {
      ...
      tipo: object.tipo,
      subjetivo: object.subjetivo as Prontuario['subjetivo'],
      objetivo: object.objetivo as Prontuario['objetivo'],
      avaliacao: object.avaliacao as Prontuario['avaliacao'],
      plano: object.plano as Prontuario['plano'],
      arquivos: object.arquivos as Prontuario['arquivos'],
