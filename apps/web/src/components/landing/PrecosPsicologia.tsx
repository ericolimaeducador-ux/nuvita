...
export function PrecosPsicologia() {
  return (
    <section id="precos-psicologia" className="scroll-mt-16 bg-card px-6 py-20">
      <div className="mx-auto max-w-6xl">
        <Reveal className="mb-10 text-center">
          <h2 className="text-3xl font-semibold">Psicologia</h2>
          <p className="mt-2 text-muted-foreground">Um plano simples, com tudo o que você precisa.</p>
        </Reveal>

        <Reveal delay={0.1} className="mx-auto max-w-md">
          <Card className="border-2 border-brand-cobalt/20 shadow-lg">
