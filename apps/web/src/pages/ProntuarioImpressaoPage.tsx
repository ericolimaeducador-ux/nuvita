...
import { TipoAtendimento, TIPO_ATENDIMENTO_LABEL, type ExameSegmentar } from '@/types';
    ...
    <>
      ...
      <div className="print:hidden flex items-center gap-3 p-4 border-b border-border">
        ...
        <span className="text-sm text-muted-foreground">
          Prévia do {isEnfermagem ? 'Registro de Enfermagem' : 'Prontuário (SOAP)'}
        </span>
        ...
        <div className="flex items-center justify-between border-b-2 border-gray-800 pb-4 mb-6">
          <div>
            <h1 className="text-base font-bold uppercase tracking-wide">
              {isEnfermagem ? 'Registro de Enfermagem' : 'Prontuário — SOAP'}
            </h1>
